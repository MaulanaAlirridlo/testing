    ...
    <!-- card body -->
        ...
        <form>
            <div class="form-group">
                ...
                id="name" name="name" placeholder="Nama Anda" required>
            </div>
            <div class="form-group">
                <input type="text" class="form-control form-control-user" 
            ...
            <div class="form-group">
                <input type="text" class="form-control form-control-user" 
                id="email" name="email" placeholder="Email Anda" required>
            </div> 
            <div class="form-group">
            ...
            <div class="form-group">
                <tr>
                    <td><input type="radio"  id="jenis_kelamin" name="gender" value="Laki Laki"> Laki-Laki </td> 
                    
                    <td><input type="radio"  id="jenis_kelamin" name="gender" value="Perempuan"> Perempuan</td>
                </tr>
            </div>
            <div class="form-group">
                <select name="agama" id="agama" class="form-control form-control-user">
                    <option value="--">--Pilih Agma--</option>
            ...
            <div class="form-group">
                <textarea name="biografi" id="biografi" cols="10" rows="1" class="form-control form-control-user"></textarea>
            </div>
